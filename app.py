...
forest_path = os.path.join(BASE_DIR, "forest.shp")
water_path = os.path.join(BASE_DIR, "waterways.shp")
bassin_path = os.path.join(BASE_DIR, "Bassin.shp")
lake_path = os.path.join(BASE_DIR, "Lake.shp")
parcs_path = os.path.join(BASE_DIR, "parcs.shp")
hydro_path = os.path.join(BASE_DIR, "hydrographie.shp")
integrale_path = os.path.join(BASE_DIR, "integrale.shp")
kba_path = os.path.join(BASE_DIR, "KBAsGlobal_2025_September_02_POL.shp")
stress_path = os.path.join(BASE_DIR, "Stress_hydrique.shp")
...
# water_path = os.path.join(BASE_DIR, "waterways.shp")
# bassin_path = os.path.join(BASE_DIR, "Bassin.shp")
# lake_path = os.path.join(BASE_DIR, "Lak)os.path.join(BASE,)os.path.join(BASE,)os.path.join(BASE,)os.path.join(BASE,)os.path.join(BASE,)
...
def load_data():
        ...
        stress_hydrique = gpd.read_file(stress_path, engine="fiona")
